"""Mosquitto certificate configuration management."""
...
class MosquittoCertConfig(BaseConfig):
    """Mosquitto certificate configuration management.

    This file contains the server certificate for Mosquitto MQTT broker
    and is written to /boot/firmware/mosquitto.d/server.crt.
    """
    ...
    def config_file(self) -> Path:
        ...
        return Path("/boot/firmware/mosquitto.d/server.crt")
    ...
    def validate(self, config: Dict[str, Any]) -> List[str]:
        ...
        if not content or not content.strip():
            errors.append("Certificate file is empty")
